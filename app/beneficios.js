    ...
    return (
        <View style={styles.internalContainer}>
           ...
           <Pressable
            ...
            <Text style={styles.formTitle}>Benefícios</Text>
            <Text style={styles.formBene}>Vale Transporte: R$****,**</Text>
            <Text style={styles.formBene}>Vale Refeição: R$****,**</Text>
            <Text style={styles.formBene}>Vale Alimentação: R$****,**</Text>
            <Text style={styles.formTitle}>Descontos</Text>
            <Text style={styles.formBene}>Total Descontado: R$****,**</Text>
        </View>
    )
}